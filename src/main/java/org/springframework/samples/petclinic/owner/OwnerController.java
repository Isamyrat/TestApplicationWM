...
class OwnerController {
	...
	public OwnerController(OwnerRepository clinicService, VisitRepository visits,VetRepository vetRepository) {
	...
	public String showOwner(@PathVariable("ownerId") int ownerId, Model model) {
		...
		model.addAttribute("active", Status.ACTIVE)
			 .addAttribute("cancelled", Status.CANCELLED)
	...
	public Vet showVets(@PathVariable("vetId") int vetId) {
